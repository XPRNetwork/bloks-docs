...
### 1. Download and install MEET.ONE. <a href="#id-1-download-and-install-nova-wallet" id="id-1-download-and-install-nova-wallet"></a>

![](<../../.gitbook/assets/image (11).png>)

MEET.ONE is available for download on iOS, and Android,

### 2. Start the app on your mobile. Go to the main page, and click "Discovery". <a href="#id-2-start-the-app-on-your-mobile-go-to-the-main-page-and-click-more" id="id-2-start-the-app-on-your-mobile-go-to-the-main-page-and-click-more"></a>

![](<../../.gitbook/assets/image (80).png>)

### 3. You can either type in Bloks at the top search bar or scroll down to Third-party Tools to find Bloks.io. <a href="#id-3-click-discovery-under-more" id="id-3-click-discovery-under-more"></a>

![](<../../.gitbook/assets/image (89).png>)

![](<../../.gitbook/assets/image (162).png>)

### 4. MEET.ONE will prompt you with a message that you are being redirected to Bloks. Click OK. <a href="#id-4-scroll-down-to-tool-section-and-click-on-bloks" id="id-4-scroll-down-to-tool-section-and-click-on-bloks"></a>
