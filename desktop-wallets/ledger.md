...
If you want to be able to interact with custom contracts on the XPR Network blockchain, you will need to turn on _Contract Data_ on your ledger device. To do this complete the following steps:
